                    ...
                    >
                      ...
                      {editingLessonId === lesson.id ? (
                        <ResizableSplit
                          ...
                          left={
                            <div className="flex flex-col gap-tight py-tight pr-tight">
                              {editDraftRestored ? (
                          ...
                          right={
                            <div className="flex h-full flex-col gap-tight bg-night/20 py-tight pl-tight">
      ...
      {creating ? (
        <div className="flex flex-col gap-tight rounded-control border border-line">
          ...
          <ResizableSplit
            ...
            dividerLabel={t("components.teacher.LessonManagerPanel.resizeSplit")}
            left={
              <div className="flex flex-col gap-tight p-stack">
                <input
            ...
            right={
              ...
              <div className="flex h-full flex-col gap-tight bg-night/20 p-stack">
